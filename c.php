...
<head>
  ...
  <link rel="preload" as="style" href="https://laravel.com/build/assets/app-409e9bd3.css" />
  <link rel="modulepreload" href="https://laravel.com/build/assets/app-2c9b9d45.js" />
  <link rel="stylesheet" href="https://laravel.com/build/assets/app-409e9bd3.css" />
...
<body x-data="{
  ...
  <div class="absolute top-0 w-full">
    <header x-trap.inert.noscroll="navIsOpen" class="relative z-50 text-gray-700 main-header" @keydown.window.escape="navIsOpen = false" @click.away="navIsOpen = false">
      ...
      <div class="relative w-full py-4 mx-auto transition duration-200 bg-white max-w-screen-2xl lg:bg-transparent lg:py-6">
        <div class="flex items-center justify-between max-w-screen-xl px-5 mx-auto">
            ...
            <li x-data="{ expanded: false }" class="relative" @keydown.window.escape="expanded = false">
              <button class="flex items-center justify-center" @click="expanded = !expanded">
                ...
                <span class="ml-3 shrink-0">
                  <svg xmlns="http://www.w3.org/2000/svg" :class="{ 'rotate-180': expanded }" class="w-4 h-4 transition-transform" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7" />
                  </svg>
                </span>
              </button>
              <div x-show="expanded" x-cloak class="absolute z-20 transition transform -translate-x-1/2 left-28" x-transition:enter="duration-250 ease-out" x-transition:enter-start="opacity-0 -translate-y-8" x-transition:enter-end="opacity-100" x-transition:leave="duration-250 ease-in" x-transition:leave-start="opacity-100" x-transition:leave-end="opacity-0 -translate-y-8">
                <div class="p-8 mt-4 transition-transform origin-top transform bg-white shadow-lg w-224" @click.away="expanded = false">
                  <ul class="relative grid gap-6 sm:grid-cols-2 md:grid-cols-3">

                    <li>
                      <a href="/docs/11.x/starter-kits#laravel-breeze" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-breeze">
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Lightweight starter kit scaffolding for new applications with Blade or Inertia.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/billing" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-cashier">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Take the pain out of managing subscriptions on Stripe or Paddle.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/dusk" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-dusk">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Automated browser testing to ship your application with confidence.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/broadcasting" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-echo">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Listen for WebSocket events broadcast by your Laravel application.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://envoyer.io" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-envoyer">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Deploy your Laravel applications to customers with zero downtime.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://forge.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-forge">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                          <img src="/img/ecosystem/forge.min.svg" alt="Forge Logo" class=" w-7 h-7" width="47" height="32">
                        </div>
                        <div class="ml-4 leading-5">
                          <div class="text-gray-900">Forge</div>
                          <span class="text-xs text-gray-700">Server management doesn&#039;t have to be a nightmare.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://herd.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-herd">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                          <img src="/img/ecosystem/herd.min.svg" alt="Herd Logo" class=" w-7 h-7" width="47" height="32">
                        </div>
                        <div class="ml-4 leading-5">
                          <div class="text-gray-900">Herd</div>
                          <span class="text-xs text-gray-700">The fastest Laravel local dev environment - now for macOS and Windows.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/horizon" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-horizon">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Beautiful UI for monitoring your Redis driven Laravel queues.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://inertiajs.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-inertia">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Create modern single-page React and Vue apps using classic server-side routing.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://jetstream.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-jetstream">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Robust starter kit including authentication and team management.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://livewire.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-livewire">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Build reactive, dynamic applications using Laravel and Blade.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://nova.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-nova">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Thoughtfully designed administration panel for your Laravel applications.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/octane" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-octane">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Supercharge your application&#039;s performance by keeping it in memory.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/pennant" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-pennant">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">A simple, lightweight library for managing feature flags.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/pint" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-pint">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Opinionated PHP code style fixer for minimalists.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/prompts" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-prompts">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Beautiful and user-friendly forms for command-line applications.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://pulse.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-pulse">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">At-a-glance insights into your application&#039;s performance and usage.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://reverb.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-reverb">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Blazing fast and scalable WebSockets for your application.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/sail" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-sail">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Hand-crafted Laravel local development experience using Docker.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/sanctum" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-sanctum">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">API and mobile application authentication without wanting to pull your hair out.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/scout" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-scout">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Lightning fast full-text search for your application&#039;s Eloquent models.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/socialite" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-socialite">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Social authentication via Facebook, Twitter, GitHub, LinkedIn, and more.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://spark.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-spark">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Launch your next business with our fully-featured, drop-in billing portal.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="/docs/11.x/telescope" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-telescope">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Debug your application using our debugging and insight UI.</span>
                        </div>
                      </a>
                    </li>
                    <li>
                      <a href="https://vapor.laravel.com" class="flex">
                        <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-vapor">
                          <span class="absolute inset-0 w-full h-full bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
                        ...
                        <div class="ml-4 leading-5">
                          ...
                          <span class="text-xs text-gray-700">Laravel Vapor is a serverless deployment platform for Laravel, powered by AWS.</span>
                        </div>
                      </a>
                    </li>
                  </ul>
          ...
          <div class="flex items-center justify-end flex-1">
            ...
            <a class="relative inline-flex hidden border border-red-600 group focus:outline-none lg:ml-4 lg:inline-flex" href="/docs">
            ...
            <button class="relative inline-flex items-center justify-center w-10 h-10 p-2 ml-2 text-gray-700 lg:hidden" aria-label="Toggle Menu" @click.prevent="navIsOpen = !navIsOpen">
      ...
      <div x-show="navIsOpen" class="lg:hidden" x-transition:enter="duration-150" x-transition:leave="duration-100 ease-in" x-cloak>
        <nav x-show="navIsOpen" x-transition.opacity x-cloak class="fixed inset-0 w-full pt-[4.2rem] z-10 pointer-events-none">
          <div class="relative w-full h-full px-5 py-8 overflow-y-auto bg-white pointer-events-auto">
            <ul>
              ...
              <li class="flex sm:justify-center"><a class="relative inline-flex w-full max-w-md mt-3 border border-red-600 group focus:outline-none" href="/docs">
                  <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                    Documentation
                  </span>
                </a>
  ...
  <div>
    <section class="relative pt-48 pb-20 overflow-hidden lg:pt-48 xl:pt-56 xl:pb-28">
      ...
      <div class="relative max-w-screen-xl px-5 mx-auto">
        ...
        <div class="absolute -translate-y-20 pointer-events-none -right-2 md:right-1/4">
          <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
        ...
        <div class="relative">
          ...
          <p class="max-w-xl mx-auto mt-6 leading-relaxed text-center text-gray-700 text-md md:mt-8 md:text-lg lg:mt-10">
          ...
          <div class="flex flex-col items-center justify-center max-w-sm gap-4 mx-auto mt-6 sm:flex-row md:mt-8 lg:mt-10">
            <a class="relative inline-flex w-full border border-red-500 group focus:outline-none sm:w-auto" href="/docs">
              <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-white uppercase transition-transform transform bg-red-500 ring-1 ring-red-500 ring-offset-1 ring-offset-red-500 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                Get Started
              </span>
            </a>
            <a class="relative inline-flex w-full border border-red-600 group focus:outline-none sm:w-auto" href="https://laracasts.com" target="_blank">
              <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                Watch Laracasts
              </span>
            </a>
  ...
  <div class="relative py-16 overflow-hidden md:pt-24 lg:pt-36">

    <div class="absolute hidden pointer-events-none lg:block -right-2 bottom-40">
      <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
    ...
    <div class="absolute hidden pointer-events-none lg:block left-2 top-48 lg:top-auto lg:bottom-64 lg:left-1/2">
      <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
    ...
    <div class="absolute hidden pointer-events-none lg:block top-20 right-1/4 md:top-48 md:right-1/4">
      <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
    ...
    <div class="relative w-full max-w-screen-xl mx-auto xl:px-5">
      <div class="relative grid w-full gap-12 lg:grid-cols-2">
        <div class="flex justify-center overflow-hidden lg:order-last">
        ...
        <div class="flex items-center justify-center w-full px-5 xl:px-0">
          <div class="sm:max-w-[480px]">
            <h2 class="text-4xl font-bold md:text-5xl">Write code for the joy of it.</h2>
            <p class="mt-6 leading-relaxed text-gray-700">Laravel values beauty. We love clean code just as much
            ...
            <a class="relative inline-flex mt-6 border border-red-600 group focus:outline-none" href="/docs">
              <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                Start Learning
              </span>
            </a>
  ...
  <div class="relative pt-12 pb-16 overflow-hidden md:pt-24 lg:pt-48">
    <div class="grid w-full max-w-screen-xl gap-12 px-5 mx-auto lg:grid-cols-2">
      ...
      <div class="flex items-center justify-center w-full">
        <div class="sm:max-w-[480px]">
          ...
          <p class="mt-6 leading-relaxed text-gray-700">Build robust, full-stack applications in PHP using
          ...
          <p class="mt-6 leading-relaxed text-gray-700">Or, let Laravel serve as a robust backend API for your
          ...
          <a class="relative inline-flex mt-6 border border-red-600 group focus:outline-none" href="/frontend">
            <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
  ...
  <div class="relative py-16 overflow-hidden md:pt-48">
    ...
    <div class="relative w-full max-w-screen-xl px-5 mx-auto">
      ...
      <h2 class="max-w-lg text-4xl font-bold md:text-5xl">Everything you need to be amazing.</h2>
      <p class="max-w-3xl mt-6 leading-relaxed text-gray-700">Out of the box, Laravel has elegant solutions for the
      ...
      <div x-data="{
        ...
        <nav class="relative flex w-full lg:max-w-xs">
          <div class="absolute top-0 hidden w-5 h-full pointer-events-none lg:block lg:w-full lg:h-8 bg-gradient-to-r lg:bg-gradient-to-b from-white"></div>
          <div class="absolute bottom-0 right-0 z-10 hidden w-5 h-full pointer-events-none lg:block lg:w-full lg:h-6 bg-gradient-to-l lg:bg-gradient-to-t from-white"></div>

          <button class="flex items-center justify-center w-6 text-gray-600 border-b border-r border-gray-100 lg:hidden bg-gray-50 disabled:text-gray-200" :disabled="scrolledLeft" @click="scrollLeft">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
              <path fill-rule="evenodd" d="M12.79 5.23a.75.75 0 01-.02 1.06L8.832 10l3.938 3.71a.75.75 0 11-1.04 1.08l-4.5-4.25a.75.75 0 010-1.08l4.5-4.25a.75.75 0 011.06.02z" clip-rule="evenodd" />
            </svg>
          </button>

          <ul id="feature-nav" class="flex flex-1 max-h-full overflow-x-auto text-sm divide-x divide-gray-100 lg:divide-x-0 lg:divide-y lg:overflow-x-visible lg:overflow-y-auto lg:overscroll-y-contain lg:block whitespace-nowrap lg:text-base" @scroll.throttle.50ms="updateScrollPosition">
            <li>
              <a href="#authentication" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'authentication' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('authentication')">
            ...
            <li>
              <a href="#authorization" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'authorization' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('authorization')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#eloquent" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'eloquent' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('eloquent')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#migrations" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'migrations' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('migrations')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#validation" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'validation' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('validation')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#notifications" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'notifications' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('notifications')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#storage" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'storage' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('storage')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#queues" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'queues' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('queues')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#scheduling" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'scheduling' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('scheduling')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#testing" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'testing' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('testing')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
            ...
            <li>
              <a href="#events" class="flex items-center gap-3 p-4 text-left lg:py-6" :class="tab === 'events' ? 'bg-white text-gray-800' : 'border-b lg:border-b-0 lg:border-r border-gray-100 bg-gray-50 text-gray-700 hover:bg-white'" @click.prevent="changeTab('events')">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 stroke-red-500">
          ...
          <button class="flex items-center justify-center w-6 text-gray-600 border-b border-l border-gray-100 lg:hidden bg-gray-50 disabled:text-gray-200" :disabled="scrolledRight" @click="scrollRight">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
        ...
        <div class="flex-1 overflow-y-auto">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'authorization'">
            <h3 class="text-2xl font-bold">Authorization</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'eloquent'">
            <h3 class="text-2xl font-bold">Eloquent ORM</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'migrations'">
            <h3 class="text-2xl font-bold">Database Migrations</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'validation'">
            <h3 class="text-2xl font-bold">Validation</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'notifications'">
            <h3 class="text-2xl font-bold">Notifications &amp; Mail</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'storage'">
            <h3 class="text-2xl font-bold">File Storage</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'queues'">
            <h3 class="text-2xl font-bold">Job Queues</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'scheduling'">
            <h3 class="text-2xl font-bold">Task Scheduling</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'testing'">
            <h3 class="text-2xl font-bold">Testing</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
          ...
          <div class="p-5 md:p-8 lg:px-12" x-cloak x-show="tab === 'events'">
            <h3 class="text-2xl font-bold">Events &amp; WebSockets</h3>
            <div class="mt-4 leading-relaxed [&_pre]:bg-[#161414] [&_pre_code.torchlight]:!bg-[#161414] [&_pre]:leading-8 [&_pre]:p-2 [&_a]:text-red-600 [&_a]:underline hover:[&_a]:no-underline [&_strong]:font-medium [&_ul]:list-disc [&_ul]:ml-4 space-y-4">
      ...
      <p class="max-w-3xl mt-12 leading-relaxed text-gray-700">We've just scratched the surface. Laravel has you
  ...
  <div class="relative pt-16 pb-24 overflow-hidden lg:pt-48">
    ...
    <div class="absolute hidden pointer-events-none lg:block right-16 top-40 md:right-auto md:left-1/2">
      <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
    ...
    <div class="absolute hidden pointer-events-none lg:block -left-2 top-64 md:top-auto md:bottom-64 md:left-2">
      <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
      ...
      <div class="relative grid w-full gap-12 lg:grid-cols-2">
        ...
        <div class="flex items-center justify-center w-full px-5 xl:px-0">
          <div class="sm:max-w-[480px]">
            ...
            <p class="mt-6 leading-relaxed text-gray-700">Laravel is committed to delivering the best testing
            ...
            <a class="relative inline-flex mt-6 border border-red-600 group focus:outline-none" href="/docs/http-tests">
              <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
                Learn More
              </span>
            </a>
  ...
  <div class="max-w-screen-xl px-5 pt-16 pb-24 mx-auto md:pt-24 lg:pt-48">
    <div class="sm:max-w-xl">
      <h2 class="text-4xl font-bold md:text-5xl">Enterprise scale without the enterprise complexity.</h2>
      <p class="mt-6 leading-relaxed text-gray-700">Our vast library of meticulously maintained packages means you're
    ...
    <ul class="relative grid gap-6 mt-10 md:grid-cols-2">

      <li>
        <a href="https://forge.laravel.com" class="flex items-start px-4 pt-4 pb-6 border border-gray-200 border-opacity-60">
          <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-forge">
      ...
      <li>
        <a href="https://vapor.laravel.com" class="flex items-start px-4 pt-4 pb-6 border border-gray-200 border-opacity-60">
          <div class="relative flex items-center justify-center w-12 h-12 overflow-hidden rounded-lg shrink-0 bg-vapor">
            <span class="absolute w-full h-full inset-0 bg-gradient-to-b from-[rgba(255,255,255,.2)] to-[rgba(255,255,255,0)]"></span>
    ...
    <ul class="relative grid gap-6 mt-10 sm:grid-cols-2 lg:grid-cols-3">
      <li>
  ...
  <div class="relative max-w-screen-xl px-5 pt-16 pb-24 mx-auto md:pt-24 lg:pt-36">
    ...
    <div class="absolute pointer-events-none -left-6 top-24">
      <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
    ...
    <h2 class="max-w-4xl mx-auto text-4xl font-bold text-center md:text-5xl">
      Loved by thousands of developers around the world.
    </h2>
    <div class="relative gap-5 space-y-5 mt-14 columns-1 sm:columns-2 lg:columns-3">
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/adam-wathan.jpg" class="object-cover object-center w-10 h-10" alt="Adam Wathan">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/aaron-francis.jpg" class="object-cover object-center w-10 h-10" alt="Aaron Francis">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/bobby-bouwmann.jpg" class="object-cover object-center w-10 h-10" alt="Bobby Bouwmann">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/erika-heidi.jpg" class="object-cover object-center w-10 h-10" alt="Erika Heidi">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/caleb-porzio.jpg" class="object-cover object-center w-10 h-10" alt="Caleb Porzio">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/zuzana-kunckova.jpg" class="object-cover object-center w-10 h-10" alt="Zuzana Kunckova">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/michael-dyrynda.jpg" class="object-cover object-center w-10 h-10" alt="Michael Dyrynda">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/chris-arter.jpg" class="object-cover object-center w-10 h-10" alt="Chris Arter">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/eric-l-barnes.jpg" class="object-cover object-center w-10 h-10" alt="Eric L. Barnes">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/freek-van-der-herten.jpg" class="object-cover object-center w-10 h-10" alt="Freek Van der Herten">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/jason-beggs.jpg" class="object-cover object-center w-10 h-10" alt="Jason Beggs">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/joseph-silber.jpg" class="object-cover object-center w-10 h-10" alt="Joseph Silber">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/steve-mcdougall.jpg" class="object-cover object-center w-10 h-10" alt="Steve McDougall">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/philo-hermans.jpg" class="object-cover object-center w-10 h-10" alt="Philo Hermans">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/luke-downing.jpg" class="object-cover object-center w-10 h-10" alt="Luke Downing">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/tony-lea.jpg" class="object-cover object-center w-10 h-10" alt="Tony Lea">
          <div class="text-xs">
      ...
      <blockquote class="relative w-full p-5 bg-white border border-gray-200 break-inside-avoid-column">
        ...
        <div class="flex items-start gap-4 mt-5">
          <img src="/images/testimonials/jack-ellis.jpg" class="object-cover object-center w-10 h-10" alt="Jack Ellis">
          <div class="text-xs">
  ...
  <div class="relative">
    <span class="hidden absolute bg-radial-gradient opacity-[.15] pointer-events-none lg:inline-flex left-[-20%] -top-24 w-[640px] h-[640px]"></span>
    <div class="relative grid max-w-screen-xl gap-12 px-5 pt-16 pb-24 mx-auto md:pt-24 lg:grid-cols-2 lg:pt-16">
      <div class="flex items-center justify-center lg:justify-start">
        <div class="sm:max-w-xl">
          <h2 class="text-4xl font-bold md:text-5xl">A community built for people like you.</h2>
          <p class="mt-6 leading-relaxed text-gray-700">Laravel is for everyone — whether you have been
            ...
            things.</p>
          <div class="grid grid-cols-2 gap-10 mt-10 md:grid-cols-3">
            <a href="https://blog.laravel.com" target="_blank" class="inline-flex items-center">
              <svg class="w-8 h-8 text-red-600" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="flex justify-center lg:justify-end">
        <div class="w-full max-w-sm px-6 pt-8 pb-12 border border-gray-200 -rotate-1 lg:px-12 lg:border-red-600">
          <img src="/images/laracon.png" class="max-w-[218px] w-full mx-auto" alt="laracon" />
          <h3 class="mt-8 text-xs font-bold text-red-700 uppercase">Watch us on Laracasts</h3>
          <h2 class="mt-3 text-4xl font-bold">Tune In</h2>
          <p class="mt-4 text-sm leading-relaxed text-gray-700">Laracasts includes free videos and tutorials
            covering the entire Laravel ecosystem. Stay up to date by watching our latest videos.</p>
          <a class="relative inline-flex mt-8 border border-red-600 group focus:outline-none" href="https://laracasts.com">
            <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
              Start Watching
            </span>
          </a>
  ...
  <div class="relative overflow-hidden">
    ...
    <div class="grid max-w-screen-xl gap-6 px-5 pt-16 pb-24 mx-auto md:pt-24 lg:grid-cols-2 lg:pt-48 lg:pb-64">
      <div class="relative flex items-center justify-center">
        <div class="absolute top-0 -translate-y-12 pointer-events-none right-8">
          <svg x-data="{
        initializeAnimation: false,
        init() {
            setTimeout(() => {
      ...
      <div class="relative flex justify-center lg:justify-end">
        <div class="sm:max-w-md">
          <h2 class="mt-8 text-4xl font-bold">Hire a partner for your next project</h2>
          <p class="mt-4 text-sm leading-relaxed text-gray-700">Laravel Partners are elite shops providing
          ...
          <a class="relative inline-flex mt-8 border border-red-600 group focus:outline-none" href="https://partners.laravel.com">
            <span class="inline-flex items-center self-stretch justify-center w-full px-4 py-2 text-sm font-bold text-center text-red-600 uppercase transition-transform transform bg-white ring-1 ring-red-600 ring-offset-1 group-hover:-translate-y-1 group-hover:-translate-x-1 group-focus:-translate-y-1 group-focus:-translate-x-1">
              Browse
              Partners
            </span>
  ...
  <footer class="relative pt-12 ">
    <div class="w-full px-5 mx-auto max-w-screen-2xl">
      <div>
      ...
      <div class="grid grid-cols-12 mt-6 md:gap-x-8 gap-y-12 sm:mt-12">
        ...
        <div class="col-span-6 text-xs md:col-span-3 lg:col-span-2">
      ...
      <div class="pt-6 pb-16 mt-10 border-t border-gray-200 ">
